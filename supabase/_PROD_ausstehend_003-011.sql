...
-- 427 Bausteine, 36 Fähigkeiten. Gender='d' (Tokens {{m|f|d}} im Text).
...
('selbstaendigkeit_nach_eintritt', 'arbeitsbereitschaft_fachwissen', 'mitarbeiter', 'd', 'sehr_gut', 2, 'Bereits nach kurzer Einarbeitungszeit erledigt {{er|sie|er/sie}} sämtliche Aufgaben sehr selbständig. {{Er|Sie|Er/Sie}} zeichnet sich durch schnelle Auffassungsgabe aus, erkennt relevante Zusammenhänge und kann sich rasch auf neue Situationen einstellen.'),
...
('ausdauer_belastbarkeit', 'arbeitsbereitschaft_fachwissen', 'mitarbeiter', 'd', 'ungenuegend', 1, 'Ausserdem ist {{er|sie|er/sie}} {{ein|eine|ein/eine}} {{Mitarbeitender|Mitarbeitende|Mitarbeitende/r}}, {{der|die|der/die}} {{seine|ihre|seine/ihre}} Aufgaben grösstenteils gut bewältigt.'),
...
('ausdauer_belastbarkeit', 'arbeitsbereitschaft_fachwissen', 'mitarbeiter', 'd', 'genuegend', 1, 'Ausserdem ist {{er|sie|er/sie}} {{ein|eine|ein/eine}} {{belastbarer|belastbare|belastbare/r}} {{Mitarbeitender|Mitarbeitende|Mitarbeitende/r}}, {{der|die|der/die}} {{seine|ihre|seine/ihre}} Aufgaben in der Regel gut bewältigt.'),
...
('ausdauer_belastbarkeit', 'arbeitsbereitschaft_fachwissen', 'mitarbeiter', 'd', 'gut', 1, 'Auch unter schwierigen Arbeitsbedingungen ist {{er|sie|er/sie}} {{ein|eine|ein/eine}} {{ausdauernder|ausdauernde|ausdauernde/r}} und {{belastbarer|belastbare|belastbare/r}} {{Mitarbeitender|Mitarbeitende|Mitarbeitende/r}}, {{der|die|der/die}} alle Anforderungen stets gut bewältigt.'),
('ausdauer_belastbarkeit', 'arbeitsbereitschaft_fachwissen', 'mitarbeiter', 'd', 'gut', 2, 'Auch unter anspruchsvollen Arbeitsbedingungen ist {{er|sie|er/sie}} {{ein|eine|ein/eine}} {{ausdauernder|ausdauernde|ausdauernde/r}} und {{belastbarer|belastbare|belastbare/r}} {{Mitarbeitender|Mitarbeitende|Mitarbeitende/r}}, {{der|die|der/die}} alle Anforderungen stets gut bewältigt.'),
...
('ausdauer_belastbarkeit', 'arbeitsbereitschaft_fachwissen', 'mitarbeiter', 'd', 'sehr_gut', 1, 'Auch unter schwierigen Arbeitsbedingungen ist {{er|sie|er/sie}} {{ein|eine|ein/eine}} {{ausdauernder|ausdauernde|ausdauernde/r}} und ausserordentlich {{belastbarer|belastbare|belastbare/r}} {{Mitarbeitender|Mitarbeitende|Mitarbeitende/r}}, {{der|die|der/die}} allen Anforderungen stets sehr gut gewachsen ist.'),
...
('verlaesslichkeit_pflichtbewusstsein', 'arbeitsweise_leistung', 'mitarbeiter', 'd', 'ungenuegend', 3, '{vorname} {nachname} fühlt sich {{seiner|ihrer|seiner/ihrer}} Aufgabe und dem Unternehmen nur bedingt verpflichtet.'),
...
('verlaesslichkeit_pflichtbewusstsein', 'arbeitsweise_leistung', 'mitarbeiter', 'd', 'genuegend', 2, 'Wir lernten {vorname} {nachname} als {{einen|eine|einen/eine}} {{zuverlässigen|zuverlässige|zuverlässigen/zuverlässige}} {{Mitarbeiter|Mitarbeiterin|Mitarbeiter/in}} kennen, {{der|die|der/die}} sich {{seiner|ihrer|seiner/ihrer}} Aufgabe und dem Unternehmen verpflichtet fühlt.'),
...
('verlaesslichkeit_pflichtbewusstsein', 'arbeitsweise_leistung', 'mitarbeiter', 'd', 'gut', 3, 'Wir erleben {vorname} {nachname} als {{einen|eine|einen/eine}} {{wertvollen|wertvolle|wertvollen/wertvolle}} {{Mitarbeiter|Mitarbeiterin|Mitarbeiter/in}}, {{der|die|der/die}} sich in anerkennenswerter Weise {{seiner|ihrer|seiner/ihrer}} Aufgabe und dem Unternehmen verpflichtet fühlt.'),
...
('selbstaendigkeit_sorgfalt_genauigkeit', 'arbeitsweise_leistung', 'mitarbeiter', 'd', 'ungenuegend', 2, '{{Er|Sie|Er/Sie}} arbeitet {{seinen|ihren|seinen/ihren}} Möglichkeiten entsprechend selbständig und trifft Entscheidungen nach vorgängigen Abklärungen.'),
...
('selbstaendigkeit_sorgfalt_genauigkeit', 'arbeitsweise_leistung', 'mitarbeiter', 'd', 'genuegend', 2, '{{Er|Sie|Er/Sie}} arbeitet sorgfältig und trifft Entscheidungen grösstenteils selbständig.'),
...
('selbstaendigkeit_sorgfalt_genauigkeit', 'arbeitsweise_leistung', 'mitarbeiter', 'd', 'gut', 2, '{{Er|Sie|Er/Sie}} arbeitet effizient und genau. Entscheidungen trifft {{er|sie|er/sie}} selbständig und mit Sachkenntnis.'),
('selbstaendigkeit_sorgfalt_genauigkeit', 'arbeitsweise_leistung', 'mitarbeiter', 'd', 'gut', 3, '{{Er|Sie|Er/Sie}} trifft Entscheidungen selbständig und mit viel Sachkenntnis.'),
...
('selbstaendigkeit_sorgfalt_genauigkeit', 'arbeitsweise_leistung', 'mitarbeiter', 'd', 'sehr_gut', 2, '{{Er|Sie|Er/Sie}} arbeitet sehr effizient und genau. Entscheidungen trifft {{er|sie|er/sie}} situationsgerecht, sehr selbständig und mit grosser Sachkenntnis.'),
('selbstaendigkeit_sorgfalt_genauigkeit', 'arbeitsweise_leistung', 'mitarbeiter', 'd', 'sehr_gut', 3, '{{Er|Sie|Er/Sie}} trifft Entscheidungen sehr selbständig, vorausschauend und mit grosser Sachkenntnis.'),
...
('konfliktfaehigkeit', 'persoenliches_verhalten', 'mitarbeiter', 'd', 'ungenuegend', 3, 'Aus Diskussionen und Auseinandersetzungen hält {{er|sie|er/sie}} sich wo möglich heraus oder meidet diese.'),
...
('kundenorientierung', 'unternehmertum', 'mitarbeiter', 'd', 'sehr_gut', 3, 'Zudem erweist {{er|sie|er/sie}} sich als {{ein|eine|ein/eine}} überaus {{kompetenter|kompetente|kompetenter/kompetente}}, sehr {{dienstleistungsorientierter|dienstleistungsorientierte|dienstleistungsorientierter/dienstleistungsorientierte}} {{Ansprechpartner|Ansprechpartnerin|Ansprechpartner/in}}, {{welcher|welche|welcher/welche}} die Anliegen der Kunden bzw. verschiedenen Anspruchsgruppen sehr ernst nimmt und deren spezifische Bedürfnisse präzise erfasst.'),
